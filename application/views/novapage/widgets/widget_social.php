<div class="widget card mb-4 widget-social">
	...
	<div class="social-bar">
		<?php
			...
			$pecahd = explode(",", $sosmed['instagram']);
		?>
		...
		<!-- <a target="https://www.instagram.com/soim.official" href="<?php echo $pecahd[2]; ?>" class="social-icon"><i class="fa fa-instagram" aria-hidden="true"></i></a> -->
